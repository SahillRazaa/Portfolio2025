import Project1 from '../assets/project_head/project1.png';
import Project2 from '../assets/project_head/project2.png';
import Project3 from '../assets/project_head/project3.png';
import Project4 from '../assets/project_head/project4.png';
import Project5 from '../assets/project_head/project5.png';
import Project6 from '../assets/project_head/project6.png';
import Project7 from '../assets/project_head/project7.png';
import Project8 from '../assets/project_head/project8.png';
import Project9 from '../assets/project_head/project9.png';
import Project10 from '../assets/project_head/project10.png';
import Project11 from '../assets/project_head/project11.png';
...
import WebsocketImage from '../assets/websocket.png';
...
import ProjectImage1_1 from '../assets/project_images/codetrace1_1.jpeg';
import ProjectImage1_2 from '../assets/project_images/codetrace1_2.jpeg';
import ProjectImage1_3 from '../assets/project_images/codetrace1_3.jpeg';
import ProjectImage1_4 from '../assets/project_images/codetrace1_4.jpeg';
import ProjectImage1_5 from '../assets/project_images/codetrace1_5.jpeg';
import ProjectImage1_6 from '../assets/project_images/codetrace1_6.jpeg';

import ProjectImage2 from '../assets/project_images/plantify1.jpeg';

import ProjectImage3_1 from '../assets/project_images/plant1.png';
import ProjectImage3_2 from '../assets/project_images/plant2.png';
import ProjectImage3_3 from '../assets/project_images/plant3.png';
import ProjectImage3_4 from '../assets/project_images/plant4.png';
import ProjectImage3_5 from '../assets/project_images/plant5.png';
import ProjectImage3_6 from '../assets/project_images/plant6.png';
import ProjectImage3_7 from '../assets/project_images/plant7.png';
import ProjectImage3_8 from '../assets/project_images/plant8.png';
import ProjectImage3_9 from '../assets/project_images/plant9.png';

import ProjectImage4_1 from '../assets/project_images/wams1_1.jpeg';
import ProjectImage4_2 from '../assets/project_images/wams1_2.jpeg';

import ProjectImage5_1 from '../assets/project_images/ludo1_1.jpeg';
import ProjectImage5_2 from '../assets/project_images/ludo1_2.jpeg';

import ProjectImage6_1 from '../assets/project_images/tourism4_1.png';
import ProjectImage6_2 from '../assets/project_images/tourism4_2.png';
import ProjectImage6_3 from '../assets/project_images/tourism4_3.png';
import ProjectImage6_4 from '../assets/project_images/tourism4_4.png';
import ProjectImage6_5 from '../assets/project_images/tourism4_5.png';
import ProjectImage6_6 from '../assets/project_images/tourism4_6.png';
import ProjectImage6_7 from '../assets/project_images/tourism4_7.png';
import ProjectImage6_8 from '../assets/project_images/tourism4_8.png';
import ProjectImage6_9 from '../assets/project_images/tourism4_9.png';
import ProjectImage6_10 from '../assets/project_images/tourism4_10.png';
import ProjectImage6_11 from '../assets/project_images/tourism4_11.png';
import ProjectImage6_12 from '../assets/project_images/tourism4_12.png';

import ProjectImage7_1 from '../assets/project_images/soul1.png';
import ProjectImage7_2 from '../assets/project_images/soul2.png';
import ProjectImage7_3 from '../assets/project_images/soul3.png';
import ProjectImage7_4 from '../assets/project_images/soul4.png';
import ProjectImage7_5 from '../assets/project_images/soul5.png';
import ProjectImage7_6 from '../assets/project_images/soul6.png';
import ProjectImage7_7 from '../assets/project_images/soul7.png';
import ProjectImage7_8 from '../assets/project_images/soul8.png';
import ProjectImage7_9 from '../assets/project_images/soul9.png';

import ProjectImage8_1 from '../assets/project_images/sahilshop1_1.jpeg';
import ProjectImage8_2 from '../assets/project_images/sahilshop1_2.jpeg';

import ProjectImage9_1 from '../assets/project_images/portfolio1_1.jpeg';
import ProjectImage9_2 from '../assets/project_images/portfolio1_2.jpeg';
import ProjectImage9_3 from '../assets/project_images/portfolio1_3.jpeg';



import ProjectImage10_1 from '../assets/project_images/chatnchill1_1.jpeg';
import ProjectImage10_2 from '../assets/project_images/chatnchill1_2.jpeg';

import ProjectImage11_1 from '../assets/project_images/ekaura1_1.jpeg';
import ProjectImage11_2 from '../assets/project_images/ekaura1_2.jpeg';
import ProjectImage11_3 from '../assets/project_images/ekaura1_3.jpeg';
...
const projectDetails = [
  {
    ...
    learning: "Deep dive into prompt engineering was critical — crafting a single prompt that works uniformly for all user inputs was the game changer. This insight, coupled with simplifying UI post user feedback from 5 developers, improved overall clarity and usability.",
  ...
  },
  {
    ...
    problemStatement: "Local nurseries lost 60% of their sales during COVID-19 due to the lack of a digital storefront or mobile presence. Plantify aims to bridge this gap by offering a dedicated mobile platform for plant shopping.",
    challenges: [
    ...
    learning: "Learned how Firestore billing works-each document read counts toward cost. Realized that backend efficiency is just as important as frontend experience in mobile apps.",
    impact: "Reduced Firestore reads by ~60%, optimizing cost for large datasets. Faster plant listing load times and smoother filtering experience for users.",
    features: [
  ...
  },
  {
    ...
    problemStatement: "Most local plant-selling businesses struggle with poor digital presentation, and many developers find it challenging to translate visually rich designs into responsive, user-friendly websites without backend integration. This project aimed to bridge that gap by building a high-fidelity plant-selling website using React, focused entirely on frontend implementation, responsiveness, and visual consistency - all derived from a detailed Figma design.",
    challenges: [
    ...
    learning: "Gained strong hands-on experience with responsive web design and CSS architecture. Learned how to maintain consistency in component styling using utility-first CSS (like Tailwind) or modular SCSS.",
    impact: "Produced a high-fidelity UI that closely matched the design spec. Built a modular codebase where UI components could easily be reused or modified.",
    features: [
  ...
  },
  {
    ...
    learning: "Learned the importance of scalability planning and robust deployment strategies for event websites with high traffic spikes. Understood the critical role of maintenance efficiency in supporting ongoing event success.",
    impact: "Achieved a 162.79% year-over-year increase in total website visits (113 visits by December 2024), surpassing prior editions’ traffic benchmarks.",
    features: [
  ...
  },
  {
    ...
    learning: "Deepened understanding of JavaScript event handling, DOM manipulation, and animation techniques. Gained experience designing complex state machines to manage game turns and player actions. Improved UI/UX design skills through interactive and dynamic frontend development.",
    impact: "Successfully built a fully playable Ludo game simulation showcasing advanced frontend logic and animation skills. Created a project portfolio piece demonstrating ability to handle complex client-side interactions and game development fundamentals.",
    features: [
  ...
  {
    id: 6,
    headline: 'Tourism Trend Analyzer – A Streamlit-based Data Exploration & Forecasting Tool',
    ...
    problemStatement: "Tourism in India, a key economic driver, lacks a centralized, visual tool for understanding trends over time—especially with massive shifts during the COVID-19 pandemic. Stakeholders struggle to make informed, data-backed decisions without an easy way to explore and predict tourism behavior.",
    challenges: [
    ...
    learning: "Real-world dataset cleaning and normalization. Conducting statistical hypothesis testing. Creating intuitive data visualizations to convey insights effectively.",
    impact: "This project can serve as a valuable decision-support tool for policymakers, tourism boards, and analysts. It brings complex datasets to life, enabling trend identification and predictive planning. The tool also significantly strengthened your practical data science and frontend visualization skills within a short 3-week timeframe.",
    features: [
  ...
  },
  {
    ...
    learning: "Deepened understanding of Provider for state management in complex Flutter apps. Mastered integration with external APIs (YouTube API). Learned audio control with just_audio and efficient image caching.",
    impact: "Successfully delivered a fully functional and engaging music app. Created a reusable architecture for future audio-based apps. Received positive feedback on performance and interface during user testing",
    features: [
  ...
  },
  {
    ...
    problemStatement: "Most e-commerce platforms either compromise on performance or lack essential user features like persistent cart, secure checkout, and smooth filtering. Many fail to deliver a reliable and responsive experience, especially across devices and sessions.",
    challenges: [
    ...
    learning: "Mastered full-stack integration using MERN. Understood secure payment systems and JWT-based auth flows. Learned persistent global state management with Redux. Improved front-end UI/UX practices for real-world e-commerce needs.",
    impact: "Delivered a scalable, production-ready e-commerce solution that offers a seamless and personalized shopping experience. The project showcases end-to-end full-stack proficiency, secure payment integration, and advanced UI development, making it ideal for demonstrating real-world application skills.",
    features: [
  ...
  },
  {
    ...
    learning: "Advanced UI/UX animation with Framer Motion. Efficient state and theme management. Clean project structure and reusability.",
    impact: "The portfolio now serves as a central platform for showcasing my skills and projects, improving professional presence, and acting as a go-to reference during interviews, internships, and collaborations.",
    features: [
  ...
  },
  {
    ...
    learning: "Deepened understanding of WebSocket implementation for real-time data transfer, efficient state management in React, and synchronization between backend and frontend states. Improved skills in MERN stack integration and designing scalable chat functionalities.",
    impact: "ChatNChill offers users a fast, reliable chat experience with clear visibility of online friends and conversation context, enhancing real-time communication. The project showcases the ability to build scalable, low-latency messaging apps suitable for broader social or professional platforms.",
    features: [
  ...
  },
  {
    ...
    problemStatement: "Ekaura needed a professional online presence to showcase their handmade ceramic products and simplify the B2B ordering process. They required a cost-effective, easy-to-manage website solution without the overhead of complex custom development.",
    challenges: [
    ...
    learning: "Gained expertise in Wix platform capabilities, including design customization, form integration, and SEO setup. Developed skills in client communication and collaboration to align website design with brand identity and business goals.",
    impact: "The Ekaura website provided the brand with a professional online storefront that enhanced visibility and credibility in the B2B market. The integrated forms improved order handling efficiency and customer engagement, supporting business growth and client satisfaction.",
    features: [
...
const experience = [
  {
    ...
    description: "Developing a next-generation Conference Management System at Certimate, integrating advanced features to streamline workflows, enhance organizer experience, and address key gaps in existing market solutions.",
  ...
  // },
  {
    ...
    title: "WAMS 2025",
    role: "Web Developer",
    description: "Drove a 162.79% YoY increase in total website visits (113 visits by December 2024) for WAMS 2025, surpassing traffic benchmarks from prior editions.",
...
const achievements = [
  {
    ...
    description: "Solved 400+ coding challenges on LeetCode, with 65% at medium difficulty, showcasing proficiency in arrays, trees, graphs, and DP.",
    logo: Leetcode,
    date: "Ongoing"
  },
  {
    ...
    description: "This award is in recognition of my excellent service to WAMS 2025, particularly in developing its website and maintaining it on a regular basis",
    logo: WAMS,
    date: "June, 2025"
  },
  {
    ...
    description: "Developed CodeTrace, an AI-powered code visualization tool that performs dry runs of user-submitted code to help learners grasp program logic. Utilized Python, React, Node.js (REST APIs), and Llama 3.2 via Ollama for real-time AI integration.",
    logo: Vashisht,
    date: "April, 2025"
  },
  {
    ...
    description: 'Mastered 17+ advanced graph algorithms—including BFS/DFS optimizations, Dijkstra’s, and Kruskal’s—in an intensive 3-day camp. Solved all three "Chocolate Problems" and earned a spot in the Hall of Fame.',
    logo: AlgoUniversity,
    date: "March, 2025"
  }
]

export { projectDisplay, projectDetails, experience, achievements };
